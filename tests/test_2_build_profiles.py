...
class TestCheckPaperOverlap(unittest.TestCase):
    ...
    def test_paper_overlap_no_match(self):
        ...
        self.assertEqual(overlap, 0.0)  # No common papers = 0.0
...
class TestBuildEnrichedAuthorProfile(unittest.TestCase):
    ...
    def test_build_enriched_author_profile_basic(self):
        """Test basic profile building"""
        with patch.object(self.bp, 'fetch_author_info_from_semantic_scholar') as mock_s2, \
             patch.object(self.bp.client.chat.completions, 'create') as mock_openai:
    ...
    def test_build_enriched_author_profile_no_semantic_scholar(self):
    ...
    def test_build_enriched_author_profile_llm_error(self):
    ...
    def test_build_enriched_author_profile_with_verified_match(self):
...
class TestFetchAuthorInfoFromSemanticScholar(unittest.TestCase):
    ...
    def test_fetch_author_with_verification(self):
        """Test author fetching with paper overlap verification"""
        with patch.object(self.bp.sch, 'search_author') as mock_search, \
             patch.object(self.bp.sch, 'get_author') as mock_get_author, \
             patch.object(self.bp, 'check_paper_overlap') as mock_overlap:
    ...
    def test_fetch_author_low_overlap_unverified(self):
    ...
    def test_fetch_author_cache_hit(self):
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_build_profile_empty_papers(self):
